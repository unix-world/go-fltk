...
// #cgo openbsd,amd64 CPPFLAGS: -I/usr/X11R6/include -I${SRCDIR}/include/openbsd/amd64 -I${SRCDIR}/include/openbsd/amd64/FL/images -I${SRCDIR}/include/openbsd/amd64/png -I${SRCDIR}/include/openbsd/amd64/zlib -I${SRCDIR}/include/openbsd/amd64/jpeg -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D_THREAD_SAFE -D_REENTRANT
